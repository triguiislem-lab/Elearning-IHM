    ...
    >
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8 border-l-4 border-yellow-400">
        <h2 className="text-xl font-semibold mb-4 text-gray-700 flex items-center">
          <MdStorage className="text-yellow-500 mr-2" size={24} />
        ...
        <div className="bg-yellow-50 p-4 rounded-lg mb-4">
          <div className="flex items-start">
            ...
            <p className="text-sm text-yellow-700">
              <strong>Attention:</strong> Nous avons détecté deux structures de
              base de données dans votre application: <code>elearning</code>{" "}
              (minuscule) et <code>Elearning</code> (majuscule). Pour assurer la
              cohérence des données, nous recommandons de standardiser la
              structure.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link
            to="/admin/database-standardization"
