...
import { fetchInstructorCourses, deleteCourse } from "../../utils/moduleUtils";
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between gap-2 mt-4">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-3 py-1.5 bg-red-600 text-white rounded-md hover:bg-red-700 transition-colors duration-300 flex-1 justify-center text-sm disabled:opacity-50"
                    >
