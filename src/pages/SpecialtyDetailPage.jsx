...
import { Star, Clock, Users, Library, ArrowRight } from "lucide-react";
      ...
      <div className="min-h-screen pt-24 pb-12">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-6 text-center">
            <Link to="/specialites" className="text-secondary hover:underline">
  ...
  return (
    <div className="min-h-screen py-8 md:py-16 bg-light">
      <div className="container max-w-7xl mx-auto px-4">
        ...
        <Breadcrumb
          customPaths={[
            { name: "Spécialités", url: "/specialties" },
            { name: specialty.name, url: `/specialite/${id}` },
          ]}
        />
            ...
            {courses.length === 0 ? (
              <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 text-center py-12">
                ...
                <p className="text-gray-500 mb-6">
                  Nous travaillons à ajouter de nouvelles formations dans cette
                  spécialité.
                </p>
